...
if __name__ == '__main__':
    ...
    # Test configuration.
    parser.add_argument('--test_iters', type=int, default=2500, help='test model from this step')
    #153
    # Miscellaneous.
    ...
    # Directories.
    parser.add_argument('--celeba_image_dir', type=str, default='data/CelebA-HQ-White-Background')
    parser.add_argument('--celeba_image_dir_skt', type=str, default='data/CelebA-HQ-White-Background-Sketch')
    parser.add_argument('--cgui_image_dir_skt', type=str, default='data/test_Sketch')
    parser.add_argument('--attr_path', type=str, default='data/CelebAMask-HQ-att.txt')
