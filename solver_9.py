...
class Solver(object):
    ...
    def __init__(self, celeba_loader, celeba_loader_skt, cgui_loader_skt, rafd_loader, config, dataX, dataY):
        ...
        self.csv_filename = "log.csv"  # CSV filename
    ...
    def train(self):
        ...
        for i in range(start_iters, self.num_iters):
            ...
            # if (i+1) % self.n_critic == 0:
                ...
                loss['G/g_loss_recXY'] = g_loss_recXY.item()
            ...
            if (i + 1) % self.log_step == 0:
                ...
                log = {"Iteration": i + 1, "Elapsed Time": et}

                # Add current iteration's data to record
                ...
                # Print the log
                print("Elapsed [{}], Iteration [{}/{}]".format(et, i + 1, self.num_iters))
                print(log)
    ...
    def test(self):
        ...
        with torch.no_grad():
            for i, (x_real,X ,c_org,fn) in enumerate(data_loader_skt):
                ...
                print('Saved real and fake images into {}...'.format(result_path1))
    ...
    def write_to_csv(self, filename):
        ...
        # Update field names to include all keys encountered in the records
        keys = set().union(*(record.keys() for record in self.records))
